...
import hospital.management.patient.patient_discharge;
...
public class Reception extends JFrame {
    Reception(){
       ...
       add(panel);
        ...
        ImageIcon i11 = new ImageIcon(ClassLoader.getSystemResource("icon/ambulane.png"));
        Image image1 = i11.getImage().getScaledInstance(250,250,Image.SCALE_DEFAULT);
        ImageIcon i22 = new ImageIcon(image1);
        JLabel label1 = new JLabel(i22);
        label1.setBounds(925,0,250,200);
        panel1.add(label1);
